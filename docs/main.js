...
var connect = function (url) {
  var mqt = MQT(url);
  return mqt.ready.then(function () { return mqt; })
};
...
function addCss () {
	...
	style.textContent = "\n\n  [svelte-36546742]#url, [svelte-36546742] #url {\n    transition: .2s\n  }\n\n  [svelte-36546742]#submit, [svelte-36546742] #submit {\n    color: inherit;\n    border: none;\n    background: none;\n    padding:0;\n    text-decoration: underline;\n    cursor: pointer;\n    transition: .2s\n  }\n  [svelte-36546742]#submit:hover, [svelte-36546742] #submit:hover {\n    color: #08f\n  }\n\n  [svelte-36546742]#root.error #url, [svelte-36546742] #root.error #url{\n    color: #f00\n  }\n  [svelte-36546742]#root.error #submit, [svelte-36546742] #root.error #submit{\n    color: #f00\n  }\n\n  [svelte-36546742]#state, [svelte-36546742] #state {\n    height: 10px;\n    background: #ccc;\n    margin-bottom: 1em;\n    transition: 1s;\n    border-radius: 0 0 2px 2px;\n  }\n\n  [svelte-36546742]#state, [svelte-36546742] #state {\n    background: #ccc;\n  }\n\n  [svelte-36546742]#root.connecting #state, [svelte-36546742] #root.connecting #state {\n    background: #000\n  }\n\n  [svelte-36546742]#root.connected #state, [svelte-36546742] #root.connected #state{\n    background: aquamarine\n  }\n\n  [svelte-36546742]#root.connected #connection, [svelte-36546742] #root.connected #connection {\n    display:none\n  }\n\n";
...
function renderMainFragment ( root, component ) {
	...
	setAttribute( div, 'svelte-36546742', '' );
	div.id = "root";
	var last_div_class = root.state;
	div.className = last_div_class;
	
	var div1 = createElement( 'div' );
	setAttribute( div1, 'svelte-36546742', '' );
	div1.id = "state";
	...
	setAttribute( form, 'svelte-36546742', '' );
	form.id = "connection";
	...
	setAttribute( input, 'svelte-36546742', '' );
	input.id = "url";
	input.type = "text";
	...
	setAttribute( input1, 'svelte-36546742', '' );
	input1.id = "submit";
	input1.type = "submit";
...
connection.on('connected', function (mqt) {
  window.x = mqt;

  console.log("Connected", mqt);

  mqt.subscribe('/foo', function (f) { return console.log(f); });


  document.body.addEventListener('click', function (){
    var v = ~~(Math.random()*255);
    mqt.publish('/debug/press', v);
  }, false);


  mqt.subscribe('/debug/press', function (v) {
